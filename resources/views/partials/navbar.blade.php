...
<nav class="hidden bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
...
<nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
        <a href="/" class="flex items-center">
            <img class="block h-16 w-auto sm:h-20 align-middle flex-1 mb-2 mt-2" src="/logo.jpeg" alt="Logo Si Damar">
        </a>
        <div class="flex items-center md:order-2">
            
            {{-- @if (Auth::check())
                <a href="/dashboard" class="mr-3 text-md hover:text-blue-500 font-semibold">Hai, {{ Auth::user()->name }}</a>
            ...
            @else
                <a href="/login" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-md px-4 py-2 md:relative md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-red-800">Login</a>
            @endif --}}
