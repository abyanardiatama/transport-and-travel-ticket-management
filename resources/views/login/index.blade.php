...
@section('container')
    ...
    <div class="flex min-h-full items-center justify-center py-32 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-sm md:max-w-xl xl:max-w-2xl space-y-1 p-10 rounded-xl shadow-lg border">
            <div>
                ...
                @endif
                <p class="mb-5 text-center text-2xl font-bold tracking-tight text-primary">Selamat Datang</p>
                <img src="/logo.jpeg" alt="" class="object-cover object-top h-28 w-full rounded-lg mb-5">
            </div>
            <form class="mt-8 space-y-4" action="/login" method="POST">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    ...
                    <div>
                        <button type="submit" class="group relative flex w-full justify-center rounded-md border border-transparent bg-blue-700 hover:bg-blue-800 py-2 px-4 text-lg font-medium text-white hover:bg-primaryDarken focus:outline-none focus:ring-2 focus:ring-primaryLighten focus:ring-offset-2">
                            Sign in
                        </button>
                    </div>
                </div>
