...
<div class="p-4">
    <div class="p-4 rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div class="border-solid border-2 border-blue-500 pl-4 h-28 rounded-lg bg-gray-50 dark:bg-gray-800 gap-4">
                <div class="py-1 text-sm lg:text-lg font-medium">Permintaan Transport</div>
                <div class="text-6xl font-bold">0</div>
            </div>
            <div class="border-solid border-2 border-blue-500 pl-2 h-28 rounded-lg bg-gray-50 dark:bg-gray-800">
                <div class="py-1 text-sm lg:text-lg font-medium">Permintaan Tiket Perjalanan Dinas</div>
                <div class="text-6xl font-bold">0</div>
            </div> 
        </div>
        {{-- End Top Content --}}
        ...
        <div class="h-48 mb-72 md:mb-52 xl:mb-40 2xl:mb-36 rounded bg-gray-50 dark:bg-gray-800">
            <div class="h-24 rounded bg-gray-50 dark:bg-gray-800">
                <div class="py-1 text-sm lg:text-lg font-medium mb-4">Surat Permintaan Transport</div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    Pelatihan Karyawan PT. Sucofindo
                                </td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    Pertemuan dengan Klien PT. Sucofindo
                                </td>
                                <td class="px-6 py-4">
